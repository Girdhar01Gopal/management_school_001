...
class ConnectionManagerController extends GetxController {
  ...
  void onInit() {
    ...
    checkConnectivity();
    _streamSubscription =
        _connectivity.onConnectivityChanged.listen(updateState as void Function(List<ConnectivityResult> event)?);
  }

  Future<bool> checkConnectivity() async {
    final connectivityResult = await (_connectivity.checkConnectivity());
    return updateState(connectivityResult as ConnectivityResult);
  }
