            ...
            child: Opacity(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: const Color(0xFF146C43).withOpacity(0.6),
                      blurRadius: 8,
                    ),
                  ],
                ),
...
// ─── Card Visuals (emoji + muted color per card, matches app screenshot) ─────
class _CardVisual {
  final String emoji;
  final Color color;
  const _CardVisual(this.emoji, this.color);
}

const Map<String, _CardVisual> _cardVisuals = {
  "Today Collection": _CardVisual("💳", Color(0xFF2B2B45)),
  "July Collection": _CardVisual("📅", Color(0xFF4A4526)),
  "Total Students": _CardVisual("🎓", Color(0xFF23414F)),
  "Total Teachers": _CardVisual("🧑‍🏫", Color(0xFF3C2C49)),
  "Total Staff": _CardVisual("💼", Color(0xFF1F4A3D)),
  "Today's Birthday": _CardVisual("🎂", Color(0xFF4A2E22)),
  "Total Boys": _CardVisual("👦", Color(0xFF244A34)),
  "Total Girls": _CardVisual("👧", Color(0xFF4A2438)),
  "Transport Students": _CardVisual("🚌", Color(0xFF23234A)),
  "All Month Report": _CardVisual("📊", Color(0xFF1F4A3D)),
  "Till Month Fee Status Report": _CardVisual("📋", Color(0xFF4A4526)),
};

_CardVisual _visualFor(dynamic item) {
  return _cardVisuals[item.name] ?? _CardVisual("📌", item.color);
}
...
class _KpiCardState extends State<_KpiCard>
  ...
  Widget build(BuildContext context) {
    ...
    final List<Color> grad = [visual.color, visual.color];
      ...
      child: ScaleTransition(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: visual.color.withOpacity(0.45),
                blurRadius: 22,
                offset: const Offset(0, 8),
              ),
            ],
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(visual.emoji, style: TextStyle(fontSize: 14.sp)),
                  ),
                  SizedBox(width: 7.w),
                  Expanded(
                    child: Text(
      ...
      child: ScaleTransition(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: visual.color.withOpacity(_pressed ? 0.35 : 0.22),
                blurRadius: _pressed ? 20 : 14,
                offset: const Offset(0, 8),
              ),
            ],
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(visual.emoji, style: TextStyle(fontSize: 16.sp)),
                  ),
                  SizedBox(width: 6.w),
                  Expanded(
                    child: Text(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(
              ...
              colors: [Color(0xFFFFFFFF), Color(0xFFF3EDF7)],
            ),
            borderRadius: BorderRadius.circular(26.r),
            border: Border.all(color: _DS.cyan.withOpacity(0.18), width: 1),
            boxShadow: [
